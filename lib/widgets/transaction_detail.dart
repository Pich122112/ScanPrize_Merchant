...
*/
  ...
  String _getWalletDisplayName(String walletCode) {
    final lowerCaseCode = walletCode.toLowerCase();
    ...
    switch (lowerCaseCode) {
      ...
      case 'boostrong':
      case 'diamond':
        // If it's already the full name, capitalize it properly
        return walletCode[0].toUpperCase() + walletCode.substring(1);
      default:
        // Return as normal for any other values
        return walletCode;
    }
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Container(
                  ...
                  child:
                      (widget.companyCategoryName.toLowerCase() == 'dm' ||
                              widget.companyCategoryName.toLowerCase() ==
                                  'diamond')
                          ? Icon(
                            Icons.diamond,
                            size: 40,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        if (widget.companyCategoryName.toLowerCase() == 'dm' ||
                            widget.companyCategoryName.toLowerCase() ==
                                'diamond')
                          Icon(Icons.diamond, size: 20, color: Colors.red)
                        else
                          Text(
                            ' ${"score".tr()}',
                            style: TextStyle(
            ...
            _buildDetailRow(
              "deduct_from".tr(),
              _getWalletDisplayName(widget.companyCategoryName),
            ),
            ...
            if (widget.remark != null && widget.remark!.isNotEmpty) ...[
              SizedBox(height: MediaQuery.of(context).size.height * 0.03),
              _buildDetailRow("remark".tr(), widget.remark!),
            ],
            ...
            _buildDetailRowWidget(
              ...
              Row(
                ...
                children: [
                  ...
                  if (widget.companyCategoryName.toLowerCase() == 'dm' ||
                      widget.companyCategoryName.toLowerCase() == 'diamond')
                    Icon(Icons.diamond, size: 20, color: Colors.black54)
                  else
                    Text(' ${"score".tr()}'),
                ],
              ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          // Value widget (could be Text or Icon row)
          DefaultTextStyle(
            style: TextStyle(
              color: Colors.black54,
              fontSize: 14,
...
//Correct with 1100 line code changes
...
// //Correct with 1007 line code changes
